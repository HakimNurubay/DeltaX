...
module.exports = {
  name: "fasttype",
  aliases: ["speedtest", "typetest"],
  category: "🎮 games",
  description: "Wanna game with ur friend? try this one :D",
    ...
    if (cooldown.has(message.author.id)) {
      ...
      const game = new FastType({
        ...
        sentence:
          ...
          fastwords[Math.floor(Math.random() * fastwords.length)] +
          " " +
          fastwords[Math.floor(Math.random() * fastwords.length)], // sentence-to-be-typed
      ...
      let fastembed = new Discord.MessageEmbed()
        .setAuthor(
          message.author.username + " | Test your Typing Speed!",
          message.author.displayAvatarURL({
            dynamic: true,
          }),
          "https://discord.gg/vdw7dwFZ2f"
        )
        .setColor("#2f3136")
      ...
      const background = await Canvas.loadImage("https://i.imgur.com/T0weIwv_d.png");

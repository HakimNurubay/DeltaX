...
class Snake {
  ...
  start() {
    ...
    let lock1 = new MessageButton().setLabel("\u200b").setStyle("gray").setID("saybye").setDisabled();

    let w = new MessageButton().setEmoji(this.options.emojis.up).setStyle("blurple").setID(w1);

    let lock2 = new MessageButton().setLabel("\u200b").setStyle("gray").setID("h").setDisabled();

    let a = new MessageButton().setEmoji(this.options.emojis.right).setStyle("blurple").setID(a1);

    let s = new MessageButton().setEmoji(this.options.emojis.down).setStyle("blurple").setID(s1);

    let d = new MessageButton().setEmoji(this.options.emojis.left).setStyle("blurple").setID(d1);
    let stopy = new MessageButton().setLabel("Stop").setStyle("red").setID(stop1);
  ...
  gameOver(m) {
    ...
    let lock2 = new MessageButton().setLabel("\u200b").setStyle("gray").setID("h").setDisabled();
    let w = new MessageButton().setEmoji(this.options.emojis.up).setStyle("blurple").setID(w1).setDisabled();

    let a = new MessageButton().setEmoji(this.options.emojis.right).setStyle("blurple").setID(a1).setDisabled();

    let s = new MessageButton().setEmoji(this.options.emojis.down).setStyle("blurple").setID(s1).setDisabled();

    let d = new MessageButton().setEmoji(this.options.emojis.left).setStyle("blurple").setID(d1).setDisabled();

    let stopy = new MessageButton().setLabel("Stop").setStyle("red").setID(stop1).setDisabled();
...
module.exports = {
  ...
  aliases: [],
  category: "🎮 games",
  description: "Wanna play snake game dude? try it :D",
